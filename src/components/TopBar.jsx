...
const TopBar = () => {
    return (
      <header className="flex flex-col justify-center items-center px-16 py-3 w-full text-xs font-semibold text-white bg-black max-md:px-5 max-md:max-w-full">
        <div className="flex flex-wrap gap-5 justify-between items-start w-full max-w-[1401px] max-md:max-w-full">
          ...
          <div className="flex flex-col mt-1 text-center max-md:max-w-full">
            <p className="max-md:mr-0.5 max-md:max-w-full">
          ...
          <div className="flex gap-2 text-center">
            <p className="grow">Call Us: (00) 1234 5678</p>
            <img
              loading="lazy"
